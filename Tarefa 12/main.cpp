...
[loop in compute_path]                                                                                                                             0,415s   

[loop in compute_path]                                                                                                
0,305s   
...
Obs: São quatro 'loops', pois a função 'compute_path' é 
executada duas vezes no programa, como a função possui dois laços
de repetição, logo, quatro loops.

Tempo Sequencial

################################

Function time -> compute_path= 0.365694
Function time -> compute_path= 1.510365
Work hard time = 1.878847
...
Function time -> compute_path= 0.371239
Function time -> compute_path= 1.531734
Work hard time = 1.905716
...
Function time -> compute_path= 0.367019
Function time -> compute_path= 1.506234
Work hard time = 1.876329
...
Function time -> compute_path= 0.363884
Function time -> compute_path= 1.503794
Work hard time = 1.870600
...
Henrique, tentamos paralelizar o código, porém, encontramos um problema. O laço com maior tempo de execução, é o primeiro
'while' da função 'compute_path', porém, não é possível paralelizá-lo devido ao fato que este tipo de laço de repetição
não é determinístico, logo, paralelizar essa sequência demandaria uma mudança da estrutura do código, os resultados abaixos,
são a paralelização do laço 'for' dentro do 'while', pois este pode ser paralelizado.

#################################################
Tempo da versão paralela - Schedule(dynamic)

First Compute Path Time = 0.580100
Second Compute Path Time = 2.379340
Work hard time = 2.962348
...
First Compute Path Time = 0.581341
Second Compute Path Time = 2.380799
Work hard time = 2.965051
...
First Compute Path Time = 0.578482
Second Compute Path Time = 2.363259
Work hard time = 2.945295
...
First Compute Path Time = 0.611238
Second Compute Path Time = 2.575895
Work hard time = 3.190051
...
First Compute Path Time = 0.580507
Second Compute Path Time = 2.699859
Work hard time = 3.283413
...
#################################################
Tempo da versão paralela - Schedule(guided)

First Compute Path Time = 0.406078
Second Compute Path Time = 1.628754
Work hard time = 2.037787

real    0m2.608s
user    0m4.407s
sys    0m0.224s

First Compute Path Time = 0.405091
Second Compute Path Time = 1.659455
Work hard time = 2.067447

real    0m2.620s
user    0m4.502s
sys    0m0.180s

First Compute Path Time = 0.474021
Second Compute Path Time = 1.915349
Work hard time = 2.392933

real    0m3.188s
user    0m5.277s
sys    0m0.283s

First Compute Path Time = 0.485499
Second Compute Path Time = 1.987334
Work hard time = 2.476801

real    0m3.274s
user    0m5.356s
sys    0m0.312s

First Compute Path Time = 0.393773
Second Compute Path Time = 1.648669
Work hard time = 2.045352
